Public Class Form2
    ...
    Dim value1, value2, memory, exp_memory, exp_value, result As Double
    Dim last_operation, prev_operation As Single
    Dim equal, exp_operation, clear_all As Boolean
    ...
    Private Sub plus_button_Click(sender As Object, e As EventArgs) Handles plus_button.Click
    ...
    Private Sub equalsButton_Click(sender As Object, e As EventArgs) Handles equalsButton.Click
        Select Case last_operation
            ...
            Case Is = 3
                ...
                TextBox1.Text = result
            Case Is = 4
                If (result = 0 Or exp_operation = True) Then
                    TextBox1.Text = exp_memory ^ Val(TextBox1.Text)
                ElseIf (result > 0 Or result < 0 And prev_operation = 0) Then
                    value2 = exp_memory ^ Val(TextBox1.Text)
                    result = value1 + value2
                    TextBox1.Text = result
                ElseIf (result > 0 Or result < 0 And prev_operation = 1) Then
                    value2 = exp_memory ^ Val(TextBox1.Text)
                    result = value1 - value2
                    TextBox1.Text = result
                ElseIf (result > 0 Or result < 0 And prev_operation = 2) Then
                    value2 = exp_memory ^ Val(TextBox1.Text)
                    result = value1 * value2
                    TextBox1.Text = result
                ElseIf (result > 0 Or result < 0 And prev_operation = 3) Then
                    value2 = exp_memory ^ Val(TextBox1.Text)
                    result = value1 / value2
                    TextBox1.Text = result
                End If
    ...
    Private Sub exponent_powerButton_Click(sender As Object, e As EventArgs) Handles exponent_powerButton.Click
        exp_memory = Val(TextBox1.Text)
        TextBox1.Text = ""
        last_operation = 4
        exp_operation = True
    End Sub

    Private Sub square_rootButton_Click(sender As Object, e As EventArgs) Handles square_rootButton.Click
        TextBox1.Text = Val(TextBox1.Text) ^ 0.5
    End Sub

    Private Sub cosineButton_Click(sender As Object, e As EventArgs) Handles cosineButton.Click
    ...
    Private Sub tangentButton_Click(sender As Object, e As EventArgs) Handles tangentButton.Click
